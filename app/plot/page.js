            ...
            {plotPlans.map((plan, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`hidden lg:inline-flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-2 text-[11px] uppercase tracking-[0.2em] font-semibold ${plan.premium ? "text-[#9aa4ff]" : "text-gray-400"
                      } ${isLeft ? "ml-24" : "-ml-24"}`}
                  >
                  ...
                  <span
                    className={`absolute top-1/2 h-px w-12 -translate-y-1/2 bg-gradient-to-r ${isLeft
                  ...
                  <div
                    className={`w-full flex ${isLeft ? "justify-start pr-12" : "justify-end pl-12"
                      }`}
                  >
                    <div
                      className={`relative w-full sm:w-[22rem] ${plan.premium
                    ...
                    >
                      ...
                      <div className="relative z-10 flex items-center justify-between">
                        <span
                          className={`text-xs font-semibold tracking-[0.3em] ${plan.premium ? "text-[#cbb7ff]" : "text-gray-400"
                            }`}
                        >
                          {plan.level}
                        </span>
                        <span
                          className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold ${plan.premium
                      ...
                      <p
                        className={`relative z-10 text-sm mt-2 ${plan.premium ? "text-white/70" : "text-gray-500"
                          }`}
                      >
                        {plan.description}
                      </p>
                      ...
                      <div className="relative z-10 mt-4 flex items-center gap-2">
                        {["N", "A", "K", "L"].map((initial, idx) => (
                          <div
                            ...
                            className={`h-8 w-8 rounded-full border-2 ${plan.premium
                        ...
                        <span
                          className={`text-xs font-semibold ${plan.premium ? "text-white/70" : "text-gray-400"
                            }`}
                        >
                          +3 members
                        </span>
