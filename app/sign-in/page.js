        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Form */}
              <motion.form onSubmit={handleEmailSignIn} variants={itemVariants}>
                  ...
                  >
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 bg-white border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-500"
