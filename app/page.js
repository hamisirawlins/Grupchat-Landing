...
export default function Home() {
  ...
  return (
        ...
        >
          ...
          >
            <div className="text-center">
              ...
              >
                Our mobile apps are currently in development. For now, you can access GrupChat through our web app and start pooling funds with your friends and family!
              </motion.p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden">
         ...
         <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 mb-24">
             ...
             <div className="absolute -top-4 left-8">
               ...
               >
                 <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2m0-10V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2m10 0H7m10 0v10a2 2 0 01-2 2H9a2 2 0 01-2-2V8" />
                 </svg>
               </motion.div>
            </div>
             <div className="mt-4">
               ...
               <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                 Set up a new pool in seconds. Define your goal, set the target amount, and invite your group members.
               </p>
          </div>
           </motion.div>
           ...
           >
             ...
             <div className="mt-4">
               ...
               <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                 Direct M-Pesa integration for instant deposits and withdrawals. No need to switch apps.
               </p>
            </div>
           </motion.div>
                   ...
                   <div className="relative h-full bg-gradient-to-b from-gray-800 to-gray-900 rounded-[2.5rem] overflow-hidden">
                     ...
                     <div className="h-full p-4 flex flex-col">
                       ...
                       <div className="flex items-center justify-between mb-6 pt-4">
                         ...
                         <div className="text-white text-sm font-semibold">GrupChat</div>
                       ...
                       <div className="space-y-4 flex-1">
                         ...
                         >
                           <div className="flex justify-between items-center mb-2">
                             <div className="text-white text-sm font-medium">Trip to Mombasa</div>
                           ...
                           <div className="text-gray-300 text-xs mt-2">KSh 15,000 / KSh 20,000</div>
                         </motion.div>
                         ...
                         >
                           ...
                           <div className="text-gray-300 text-xs mt-2">KSh 2,250 / KSh 5,000</div>
                         </motion.div>
          </div>
        </div>
      </div>
         ...
         <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 mb-24">
           ...
           >
             ...
             <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-200/50 hover:border-blue-400/50 transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105">
               ...
               <p className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300">
                 Direct integration with M-Pesa means instant deposits and withdrawals. No manual tracking needed.
               </p>
             </div>
           </motion.div>
           ...
           >
             ...
             <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-purple-200/50 hover:border-purple-400/50 transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105">
               ...
               <p className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300">
                 Turn group plans into reality. Whether it's a trip, gift, or investment, reach your goals faster together.
               </p>
             </div>
           </motion.div>
         </div>
           ...
           <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-purple-200/50 shadow-xl">
             <div className="max-w-3xl mx-auto text-center">
               <motion.div
                 ...
                 viewport={{ once: true }}
               >
                 <svg className="h-12 w-12 text-purple-400 mx-auto" fill="currentColor" viewBox="0 0 32 32">
               ...
               <motion.blockquote
                 ...
                 viewport={{ once: true }}
               >
                 "GrupChat has made it so easy to organize girl trips. No more chasing people for contributions or wondering where the money went!"
               </motion.blockquote>
               ...
               <motion.div
                 ...
                 viewport={{ once: true }}
               >
                 <p className="text-base font-semibold text-purple-600 mb-1">Sarah N.</p>
             ...
             >
               <div className="flex flex-col items-center">
                 ...
                 >
                   ...
                   <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                     Use your existing M-Pesa Phone Number to transact.Enjoy instant deposits and withdrawals.
                   </p>
                 </motion.div>
            </div>
             </motion.div>
     ...
     <section id="faq" className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 relative overflow-hidden">
       {/* Background elements */}
       <div className="absolute inset-0 overflow-hidden">
         <motion.div
           ...
           {[
            ...
            //  },
             ...
             },
             {
               ...
               answer: "Yes, you can withdraw your contribution at any time before the goal is reached. Simply request a withdrawal through the app and receive your money back via M-Pesa instantly."
             },
             {
               question: "How much does GrupChat cost?",
               answer: "GrupChat is free to use! We only charge a small transaction fee (less than 2%) when money is withdrawn from pools."
             },
             {
               question: "Can I create multiple pools?",
               answer: "Absolutely! You can create as many pools as you want and participate in multiple pools created by your friends and family."
             },
             {
           ...
           >
             ...
             >
               ...
               <div className="text-left">
                 <div className="text-xs text-gray-600 group-hover:text-gray-700">Get it on</div>
             ...
             >
               ...
               <div className="text-left">
                 <div className="text-xs text-gray-600 group-hover:text-gray-700">Download on the</div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
           ...
           >
             ...
             <p className="text-gray-400 mb-6 max-w-md">
               Powering plans beyond the chat. Pool M-Pesa funds with friends and family to achieve your group goals with transparency and trust.
             </p>
