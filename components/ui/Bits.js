...
export function StickyAction({ children }) {
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-30 border-t border-black/[0.08] bg-white/90 px-6 py-3 backdrop-blur sm:static sm:z-auto sm:flex-1 sm:border-0 sm:bg-transparent sm:p-0 sm:backdrop-blur-0">
